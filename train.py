...
if __name__ == '__main__':
    ...
    run_dir = f"training/{args.dataset}/seed{args.seed}/{name_with_datetime(args.run_name)}"
    ...
    if args.classification:
        out, eval_res = tasks.eval_classification(model, data, train_slice, valid_slice, test_slice, scaler, pred_lens,
